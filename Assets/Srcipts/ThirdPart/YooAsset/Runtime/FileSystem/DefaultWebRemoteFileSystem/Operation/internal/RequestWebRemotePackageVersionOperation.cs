...
namespace YooAsset
{
    internal class RequestWebRemotePackageVersionOperation : AsyncOperationBase
    {
        ...
        internal RequestWebRemotePackageVersionOperation(DefaultWebRemoteFileSystem fileSystem, bool appendTimeTicks,
            int timeout)
        {
        ...
        internal override void InternalOnStart()
        {
            _requestCount = WebRequestCounter.GetRequestFailedCount(_fileSystem.PackageName,
                nameof(RequestWebRemotePackageVersionOperation));
