...
namespace YooAsset
{
    internal class DWRFSRequestPackageVersionOperation : FSRequestPackageVersionOperation
    {
        ...
        internal DWRFSRequestPackageVersionOperation(DefaultWebRemoteFileSystem fileSystem, bool appendTimeTicks,
            int timeout)
        {
            ...
            if (_steps == ESteps.RequestPackageVersion)
            {
                if (_requestWebPackageVersionOp == null)
                {
                    _requestWebPackageVersionOp =
                        new RequestWebRemotePackageVersionOperation(_fileSystem, _appendTimeTicks, _timeout);
